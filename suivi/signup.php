...
<!-- Mirrored from educate.frontted.com/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 Sep 2020 02:22:22 GMT -->
...
<body class="layout-login-centered-boxed">
    ...
    <div class="layout-login-centered-boxed__form">
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-4 navbar-light">
            <a href="dashboard.php" class="navbar-brand text-center mb-2 mr-0 flex-column" style="min-width: 0">
                <!-- LOGO -->
                <svg width="40px" viewBox="0 0 27 26" version="1.1" xmlns="http://www.w3.org/2000/svg"
